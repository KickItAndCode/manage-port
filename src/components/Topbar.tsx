...
export function Topbar() {
  ...
  return (
    <header className="flex items-center justify-between px-8 py-4 border-b border-border bg-card text-foreground shadow-md transition-colors duration-300">
      <div className="flex-1 flex items-center gap-4">
        <input
          type="text"
          placeholder="Search properties..."
          className="bg-input text-foreground px-4 py-2 rounded-lg border border-border focus:outline-none focus:ring-2 focus:ring-primary w-96 transition-colors duration-200"
        />
      </div>
