...
import { UtilityAnomalies } from "@/components/UtilityAnomalies";
import { UtilityReminders } from "@/components/UtilityReminders";
...
export default function DashboardPage() {
  ...
  const [utilityResponsibilityModalOpen, setUtilityResponsibilityModalOpen] =
    useState(false);
  const [loading, setLoading] = useState(false);
  const [dashboardFilters, setDashboardFilters] =
    useState<DashboardFiltersType>({});
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
            <div className="min-w-0">
              ...
              <p className="text-muted-foreground mt-1 text-sm leading-relaxed">
                Welcome back! Here&apos;s an overview of your real estate
                portfolio.
              </p>
            </div>
            <div className="flex justify-end items-center sm:flex-col sm:items-end gap-2">
        ...
        {/* Quick Filters - only show if user has properties */}
        {!hasNoProperties && (
          <section className="mb-4 sm:mb-8" aria-labelledby="filters-heading">
        ...
        {/* KPI Cards - only show if user has properties */}
        {!hasNoProperties && userSettings.dashboardComponents.showMetrics && (
          <section className="mb-4 sm:mb-8" aria-labelledby="kpi-heading">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-3">
                ...
                >
                  ...
                  <div className="text-center">
                    <span className="text-sm sm:text-sm font-medium block">
                      Property Wizard
                    </span>
                    <span
                      className={`text-xs ${hasNoProperties ? "text-primary/80" : "text-muted-foreground"}`}
                    >
                      Add Properties
                    </span>
                  </div>
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-2 p-4 sm:p-4 rounded-lg bg-background hover:bg-muted/50 transition-colors border border-border hover:border-primary/30 min-h-[80px] sm:min-h-[100px] relative"
                >
                  {selectedProperty && (
                    <div className="absolute -top-1 -right-1">
                      ...
                      >
                        {selectedProperty.name.length > 12
                          ? selectedProperty.name.substring(0, 10) + "..."
                  ...
                  <div className="text-center">
                    ...
                    {selectedProperty && (
                      <span className="text-xs text-muted-foreground block mt-0.5">
                        for{" "}
                        {selectedProperty.name.length > 15
                          ? selectedProperty.name.substring(0, 13) + "..."
                          : selectedProperty.name}
                      </span>
                    )}
                  </div>
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-2 p-4 sm:p-4 rounded-lg bg-background hover:bg-muted/50 transition-colors border border-border hover:border-primary/30 min-h-[80px] sm:min-h-[100px] disabled:opacity-50 relative"
        ...
        {!hasNoProperties && (
          <>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-6">
                  ...
                  >
                    <LineChart
                      ...
                      onClick={(data) => handleRevenueDrillDown(data)}
                    >
            ...
            {(userSettings.dashboardComponents.showCharts ||
              ...
              <section
                className="mb-4 sm:mb-8"
                aria-labelledby="additional-charts-heading"
              >
                <h2 id="additional-charts-heading" className="sr-only">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-6">
                  ...
                  {userSettings.dashboardComponents.showCharts && (
                    ...
                    >
                      <BarChart
                        data={statusData}
                        onClick={(data) => handlePropertyStatusDrillDown(data)}
                      >
                        <CartesianGrid strokeDasharray="3 3" />
                        <XAxis
                          dataKey="name"
                        ...
                        <YAxis
                          ...
                          domain={[
                            0,
                            (dataMax: number) => Math.max(dataMax * 2, 1),
                          ]}
                        />
                        <Tooltip content={propertyTooltipConfig} />
                        <Bar
                    ...
                    <Card className="p-3 sm:p-6">
                      ...
                      <div className="space-y-2 sm:space-y-4">
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-2 sm:p-4 bg-green-50 dark:bg-green-950/20 rounded-lg gap-1 sm:gap-0">
                          <span className="text-gray-700 dark:text-gray-300 text-xs sm:text-base">
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-2 sm:p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg gap-1 sm:gap-0 border-t-2 border-blue-200 dark:border-blue-800">
                          <span className="text-gray-700 dark:text-gray-300 text-xs sm:text-base font-medium">
                            Net Monthly Income
                          </span>
            ...
            <LeaseForm
              ...
              initial={
                dashboardFilters?.propertyId
                  ? {
                      propertyId: dashboardFilters.propertyId,
                      tenantName: "",
                      startDate: "",
                      endDate: "",
                      rent: 0,
        ...
        <Dialog
          open={utilityBillModalOpen}
          onOpenChange={setUtilityBillModalOpen}
        >
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
